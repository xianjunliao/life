...
public class MailUtils {
	...
	public static String myEmailAccount = "xianjun_liao@126.com";
	public static String myEmailPassword = "stephen201703";
	...
	public static void main(String[] args) throws Exception {
		sendMail(receiveMailAccount, "我正在测试。。。", "hahahahahaha");
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String title, String text) throws Exception {
		...
		message.setFrom(new InternetAddress(sendMail, "Free Life", "UTF-8"));

		// 3. To: 收件人（可以增加多个收件人、抄送、密送）
		message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, title, "UTF-8"));
	...
	public static void sendMail(String receiveMailAccount, String title, String text) {
		try {
