...
<body style="width: 99%; height: 99%; margin: 5px 5px 5px 5px; overflow: hidden; border-radius: 5px;">
	...
	<div data-options="region:'north',title:'',split:false" style="height:20px;"><span style="font-family:sans-serif;font-size: 12px;font-style: oblique;color: #b7958b;"> >>学海无涯 >码农的自强不息 </span></div>
