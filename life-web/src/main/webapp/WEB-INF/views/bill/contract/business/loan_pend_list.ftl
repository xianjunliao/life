...
<@m.htmlTemplate title="待放款" javascripts=[] >
	<!-- BODY BEGIN -->
	<@m.navTips content="工作台 &gt; 提单系统 &gt; 业务处理 &gt; 待放款"/>
	...
	<div id="area-form" style="width: 100%;">
		...
		<div id="func_operate">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toInfoSupply()">信息补登</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toPrint()">合同/资料打印</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toUpload()">上传放款资料</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toAddRemark()">添加放款备注</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toLoanApprove()">放款审批意见</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toApplyLoan()">申请放款</a>
		</div>
	</div>
	<!-- 表单  END-->
	...
	<!-- BODY END -->
	<!-- 弹窗  END-->
	<table id="contractDocDialog" data-options="border:true"></table>
	...
	<script type="text/javascript">
		...
		//合同打印
        function toPrint(){
        	var row = $('#todoGrid').datagrid('getSelected');
        	if(row==null || typeof(row)=='undefined' ){
        		$.messager.alert('提示', '请选择一行数据！', 'info');
        		return;
        	}
        	var serialNo=row.serialNo;
        	var url = "/docTemplate/toPrintContract?serialNo="+serialNo;
        	openDialogPage("contractDocDialog",url,null,{title:'合同/资料打印'}); 
        }
	</script>
	<!-- JAVASCRIPT END -->
