...
<@m.htmlTemplate title="附条件的批准" javascripts=[] >
	<!-- BODY BEGIN -->
	<@m.navTips content="工作台 &gt; 提单系统 &gt; 业务处理 &gt; 附条件的批准"/>
	...
	<div id="area-form" style="width: 100%;">
		...
		<div id="func_operate">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toViewSign()">查看签署意见</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toSign()">签署意见</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toSubmit()">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toViewApprove()">查看批准条件</a>
		</div>
	</div>
	<!-- 表单  END-->
