...
<@m.htmlTemplate title="待补充放款资料" javascripts=[] >
	<!-- BODY BEGIN -->
	<@m.navTips content="工作台 &gt; 提单系统 &gt; 业务处理 &gt; 待补充放款资料"/>
	...
	<div id="area-form" style="width: 100%;">
		...
		<div id="func_operate">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toUpload()">上传放款文件</a>
		...
		<table id="todoGrid" data-options="toolbar:'#area-form'">
			<thead>
				<tr>
					...
					<th data-options="field:'docExpiryDate',width:80">资料补充截止日期</th>
