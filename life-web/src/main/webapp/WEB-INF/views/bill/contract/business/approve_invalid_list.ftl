...
<@m.htmlTemplate title="审批失效" javascripts=[] >
	<!-- BODY BEGIN -->
	<@m.navTips content="工作台 &gt; 提单系统 &gt; 业务处理 &gt; 审批失效"/>
	...
	<div id="area-form" style="width: 100%;">
		...
		<div id="func_operate">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toRefreshSign()">重新签署意见</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toViewSign()">查看签署意见</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="toSubmit()">重新提交</a>
		</div>
	</div>
	<!-- 表单  END-->
