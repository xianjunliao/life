...
<script type="text/javascript">
	...
	function next() {
		window.location.replace(basePath + "register2");
	}
</script>
</head>
<body>
	<div class="container">
		<section id="content">
			<form action="">
				...
				<div>
					<input type="submit" value="注册" /> <input type="submit" value="下一步" onclick="next()" /> <a href="${base }fullLogin">账号密码登录</a> <a href="${base }login">身份编码登录</a>
				</div>
			</form>
			<!-- form -->
