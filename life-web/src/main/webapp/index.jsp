...
<script type="text/javascript">
	...
	function ing(v) {
		$('#world').append('&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="intoWorld(' + v + ')" style="height: 30px; margin-bottom: 3px; text-decoration: underline; font-size: 18px"><b>into your world</b></a>');
	}
	function playMp3(songName) {
		$('#audios').append('&nbsp;&nbsp;&nbsp;&nbsp;<audio style="height: 30px;" id="audio" src="${base}static/music/'+songName+'"></audio>');
